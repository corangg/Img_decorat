...
class HueEditViewBrightnessUseCase(private val hueRepository: HueRepository) {
    fun excute(listData: ListData, brightness: Int) : LinkedList<ViewItemData> {
        return hueRepository.editViewBrightness(listData, brightness)
    }
}